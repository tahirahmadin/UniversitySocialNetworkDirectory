...
$maxfac="SELECT * FROM `student` WHERE faculty_name='$fac'";
...
$rcountfac=0;
$rankfac="SELECT * FROM `student` WHERE faculty_name='$fac' ORDER BY views DESC";
    ...
    <div class="col-md-9">
      ...
      <ul class="list-group media-list media-list-stream">
        <li class="list-group-item p-a">
          <h3 class="m-a-0">Top 20 Profiles: <?php echo $row['faculty_name']?></h3>
        </li>
...
$count=0;
$loop= "SELECT * FROM `student` WHERE faculty_name='$fac' ORDER BY views DESC LIMIT 20";
...
<div class=container">
  ...
  <thead class="thead-light">
    ...
    <th scope="col"><div class="text-center">Profile</div></th>
  </tr>
  </thead>
  <tbody>
